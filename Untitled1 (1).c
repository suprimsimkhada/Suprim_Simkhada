...
int main()
    ...
    system("cls");
     ...
     switch(r1)
		{
		case 1:
		printf("\n\nC Programming Teacher of LEC?");
		printf("\n\nA.Hari Sir\t\tB.Binod Sir\n\nC.Sandesh Sir\t\tD.Dhiraj Sir");
		if (toupper(getch())=='C')
			{
			    printf("\n\nCorrect!!!");count++;
			    getch();
		       ...
		       {
		           printf("\n\nWrong!!! The correct answer is Sandesh Sir");
		           getch();
		       break;
		       }

        case 2:
		printf("\n\n\nWhich Country won the worldcup 2022");
		printf("\n\nA.France\t\tB.Denmark\n\nC.Argentina\t\tD.Finland");
		if (toupper(getch())=='C')
			{printf("\n\nCorrect!!!");count++;
			getch();
			break;}
		else
		       {printf("\n\nWrong!!! The correct answer is Argentina");
		       getch();
		       break;}
		...
		if (toupper(getch())=='B')
			...
			break;}
		       ...
		       {printf("\n\nWrong!!! The correct answer is Lalitpur");
		       getch();
		       break;}
